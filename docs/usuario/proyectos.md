# 🏗️ Gestión de Proyectos - Guía Completa

Los proyectos son el núcleo de Ecodisseny. Aquí aprenderás a crearlos, gestionarlos y hacer seguimiento eficientemente.
...
3. **Filtros disponibles**:
   - 🏷️ Por estado (Activo, Pausado, Finalizado)
   - 👤 Por responsable
...
El sistema te ayuda con sugerencias inteligentes:

- **🏢 Cliente**: Escribe y selecciona de clientes existentes
- **📍 Ubicación**: Parroquias y poblaciones predefinidas
- **👥 Responsable**: Lista de recursos disponibles
- **🏷️ Tipo**: Categorías estándar de proyectos

## 📊 Gestionar Proyecto Existente
...
- **Acciones disponibles**: Solo lectura y reportes
- **Registro de horas**: ❌ No permitido
- **Presupuestos**: ❌ No se pueden modificar

### **🔄 Cambiar Estado**

1. **Abrir proyecto** → **Dropdown de estado**
2. **Seleccionar nuevo estado**
3. **Confirmar cambio** (algunos cambios son irreversibles)

## 📊 Trabajar con Listas

### **🔍 Filtros Avanzados**

En la lista de proyectos puedes filtrar por:

- **🏷️ Estado**: Activo, Pausado, Finalizado, Todos
- **👤 Responsable**: Mis proyectos, Todos, Por persona
- **📅 Período**: Últimos 30 días, Este mes, Este año, Personalizado
- **🏢 Cliente**: Por empresa específica
- **📍 Ubicación**: Por parroquia o población
...
- 🏷️ **Estado** (activos primero)

### **📊 Vista de Tarjetas vs Lista**

- **Vista Lista**: Más información en menos espacio
- **Vista Tarjetas**: Más visual, ideal para navegación rápida
...
- **Proyectos padre/hijo**: Para obras complejas
- **Referencias cruzadas**: Entre proyectos del mismo cliente
- **Historiales**: Ver proyectos anteriores del cliente

### **📋 Plantillas de Proyecto**

- **Crear plantilla** desde proyecto existente
- **Usar plantilla** para nuevo proyecto similar
...
Ejemplos:
- REFORMA - García Family - Escaldes - 2025
- OBRA NUEVA - Constructora XYZ - Andorra Vella - 2025
- MANTENIMIENTO - Edificio Central - Encamp - 2025
```

### **✅ Gestión de Fechas**

- **Fecha inicio realista**: Considera permisos y planificación
- **Fecha fin con margen**: Añade 10-15% de tiempo extra
- **Revisión periódica**: Actualiza fechas según progreso real

### **✅ Asignación de Responsables**

- **Un responsable principal**: Evita confusiones
- **Equipo definido**: Lista clara de participantes
- **Comunicación**: Notificar cambios de responsabilidad

### **✅ Documentación**

- **Descripción detallada**: Qué, cómo, cuándo, dónde
- **Archivos adjuntos**: Planos, fotos, documentos
- **Notas de progreso**: Actualizaciones regulares
